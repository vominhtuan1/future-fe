  ...
  return (
    <div className="relative group border-[1px] px-4 py-3 border-light-gray overflow-hidden">
      ...
      <div className="absolute transition-all duration-150 ease-out delay-75 group-hover:right-4 -right-12 top-2/3">
        <CircleBtn type="black">
          <Delete className="w-5 h-5 text-white" />
        </CircleBtn>
      </div>
      <p className="text-body-2">Nguyễn Văn An</p>
      <p className="text-body-2">0987654321</p>
      <p className="w-4/5 text-body-2">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea porro
        quibusdam voluptates consectetur amet fugit
      </p>
    </div>
  );
}
