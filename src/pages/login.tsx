    ...
    <div className="flex items-center justify-center h-[400px]">
      <div className="h-[75%] w-[60%] flex items-center shadow-lg p-[20px]">
        <div className="flex flex-1 flex-col items-center">
          <div
            className="w-[200px] pt-[15px] pr-[25px] pb-[15px] pl-[25px] mb-[20px] flex items-center font-bold bg-red-700 text-white rounded cursor-pointer"
            onClick={google}
          >
            <img src={Google} alt="" className="w-[20px] h-[20px] mr-[10px]" />
            Google
          </div>
          <div className="w-[200px] pt-[15px] pr-[25px] pb-[15px] pl-[25px] mb-[20px] flex items-center font-bold bg-blue-700 text-white rounded cursor-pointer">
            <img src={Facebook} alt="" className="icon" />
            Facebook
          </div>
          <div
            className="w-[200px] pt-[15px] pr-[25px] pb-[15px] pl-[25px] mb-[20px] flex items-center font-bold bg-black text-white rounded cursor-pointer"
            onClick={github}
          >
